...
public class SvgMarkerParsingTests
{
    ...
    {
        var path = Path.Combine("Assets", "Svg", "painting-marker-05-f.svg");
    ...
    {
        var path = Path.Combine("Assets", "Svg", "painting-marker-04-f.svg");
        var document = SvgDocument.Open<SvgDocument>(path);
    ...
    {
        var path = Path.Combine("Assets", "Svg", "painting-marker-properties-01-f.svg");
        var document = SvgDocument.Open<SvgDocument>(path);
