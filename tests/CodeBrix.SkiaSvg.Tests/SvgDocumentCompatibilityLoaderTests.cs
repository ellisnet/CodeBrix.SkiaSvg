...
public class SvgDocumentCompatibilityLoaderTests
{
    ...
    public void OpenPath_AppliesImportedStylesheets()
    {
        ...
        try
        {
            ...
            var fill = Assert.IsType<SvgColorServer>(circle.Fill);

            Assert.Equal(Color.Green.ToArgb(), fill.ColorValue.ToArgb());
        }
        finally
        {
    ...
    public void FromSvg_IgnoresEmptyStyleElements()
    {
        ...
        Assert.Equal(Color.Red.ToArgb(), fill.ColorValue.ToArgb());
    }
    ...
    public void OpenPath_IgnoresImportedStylesheetsAfterStyleRules()
    {
        ...
        try
        {
            ...
            Assert.Equal(Color.Blue.ToArgb(), fill.ColorValue.ToArgb());
        }
        finally
        {
            Directory.Delete(tempDirectory, recursive: true);
    ...
    public void FromSvg_IgnoresUnsupportedStyleElementTypes()
    {
        ...
        var defaultFill = Assert.IsType<SvgColorServer>(defaultRect.Fill);
        var unsupportedFill = Assert.IsType<SvgColorServer>(unsupportedRect.Fill);

        Assert.Equal(Color.Green.ToArgb(), defaultFill.ColorValue.ToArgb());
        Assert.Equal(Color.Green.ToArgb(), unsupportedFill.ColorValue.ToArgb());
    }
    ...
    public void FromSvg_LinkPseudoClassDoesNotStyleNonLinkTextSiblings()
    {
        ...
        var textFill = Assert.IsType<SvgColorServer>(text.Fill);
        var anchorFill = Assert.IsType<SvgColorServer>(anchor.Fill);

        Assert.Equal(Color.Black.ToArgb(), textFill.ColorValue.ToArgb());
        Assert.Equal(Color.Red.ToArgb(), anchorFill.ColorValue.ToArgb());
    }
    ...
    public void FromSvg_LinkPseudoClassStylesTextContainerWhenLinkOwnsEntireTextRun()
    {
        ...
        Assert.Equal(Color.Red.ToArgb(), textFill.ColorValue.ToArgb());
        Assert.Equal(Color.Red.ToArgb(), anchorFill.ColorValue.ToArgb());
    }
    ...
    {
        var processorType = typeof(SvgDocumentCompatibilityLoader).Assembly.GetType("CodeBrix.SvgParse.SvgCssCompatibilityProcessor");
    ...
    public void OpenPath_IgnoresImportTokensInsideStrings()
    {
        ...
        try
        {
            ...
            var fill = Assert.IsType<SvgColorServer>(text.Fill);
