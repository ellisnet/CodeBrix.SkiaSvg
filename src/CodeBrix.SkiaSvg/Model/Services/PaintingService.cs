...
internal static class PaintingService
{
    ...
    internal static SKColor GetColor(SvgColorServer SvgColorServer, float opacity, DrawAttributes ignoreAttributes)
    {
    ...
    internal static SKColor? GetColor(SvgVisualElement svgVisualElement, SvgPaintServer server)
    {
        ...
        if (server is SvgColorServer stopColorSvgColorServer)
        {
            return GetColor(stopColorSvgColorServer, 1f, DrawAttributes.None);
        }
    ...
    internal static SvgColorInterpolation GetColorInterpolation(SvgElement svgElement)
    {
