...
internal static class SvgSceneTextCompiler
{
        ...
        out SKRect? filterClip)
    {
        ...
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstChildren = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstX = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstY = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstWidth = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstHeight = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstFilterUnits = null;
        CodeBrix.SvgParse.FilterEffects.SvgFilter firstPrimitiveUnits = null;
        ...
        var primitives = firstChildren.Children.OfType<CodeBrix.SvgParse.FilterEffects.SvgFilterPrimitive>().ToList();
        if (primitives.Count != 1 ||
            primitives[0] is not CodeBrix.SvgParse.FilterEffects.SvgGaussianBlur gaussianBlur)
        {
            return false;
        }

        if (!string.IsNullOrWhiteSpace(gaussianBlur.Input) &&
            !string.Equals(gaussianBlur.Input, CodeBrix.SvgParse.FilterEffects.SvgFilterPrimitive.SourceGraphic, StringComparison.Ordinal))
        {
            return false;
        }
    ...
    private static bool TryGetLinkedFilters(SvgVisualElement visualElement, out List<CodeBrix.SvgParse.FilterEffects.SvgFilter> filters)
    {
        filters = new List<CodeBrix.SvgParse.FilterEffects.SvgFilter>();

        var currentFilter = SvgService.GetReference<CodeBrix.SvgParse.FilterEffects.SvgFilter>(visualElement, visualElement.Filter);
        ...
        do
        {
            ...
            currentFilter = SvgService.GetReference<CodeBrix.SvgParse.FilterEffects.SvgFilter>(currentFilter, currentFilter.Href);
